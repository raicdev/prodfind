...
export const heroTexts = [
  {
    ref: "default",
    title: {
      default: "A fastest way to",
      highlight: "find products",
    },
  },
  {
    ref: "producthunt",
    title: {
      default: "Product Hunt's",
      highlight: "Open-source alternative",
    },
  },
];

export const Hero = ({ refer }: { refer: string }) => {
  const heroText = heroTexts.find((text) => text.ref === refer) || heroTexts.find((text) => text.ref === "default");
  ...
  return (
    <section className="relative w-full overflow-hidden bg-white dark:bg-black">
      ...
      <div className="w-full container mx-auto relative z-10 flex flex-col items-center justify-center py-20 text-center md:py-32">
        ...
        <div className="mb-6 max-w-4xl text-5xl font-bold tracking-tighter text-foreground md:text-7xl">
          {heroText?.title.default}
          <p className="max-w-4xl text-5xl font-bold tracking-tighter text-foreground md:text-7xl bg-gradient-to-r from-primary via-foreground to-primary bg-clip-text text-transparent">
            {heroText?.title.highlight}
          </p>
        </div>
      ...
      <div className="relative z-10 w-full pb-20 [mask-image:linear-gradient(to_top,white,transparent)]">
        <div className="container mx-auto flex flex-wrap items-center justify-center gap-x-12 gap-y-4 md:justify-between">
