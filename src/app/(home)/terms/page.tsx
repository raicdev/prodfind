    ...
    <div className="container mx-auto px-4 py-8 max-w-4xl">
      ...
      <div className="prose prose-gray dark:prose-invert max-w-none">
        ...
        <section className="mb-8">
          ...
          <p>
            These Terms of Service ("Terms") govern your use of Prodfind
        ...
        <section className="mb-8">
          ...
          <p>
            Prodfind is a platform for discovering, sharing, and managing
            products. Users can post product information, search for products,
            and bookmark items of interest.
          </p>
        </section>
        ...
        <section className="mb-8">
          ...
          <p>
            ...
            account. You must provide accurate and up-to-date information during
            registration.
          </p>
        </section>
        ...
        <section className="mb-8">
          ...
          <ul className="list-disc pl-6 space-y-2">
            ...
            <li>
              Do not engage in spam or inappropriate promotional activities
            </li>
            ...
            <li>
              Do not post content that violates applicable laws, regulations, or
        ...
        <section className="mb-8">
          ...
          <p>
            Users retain ownership of content they post. However, by posting
            content, you grant us a license to display and distribute that
        ...
        <section className="mb-8">
          ...
          <p>
            ...
            do not guarantee availability, accuracy, or completeness of the
        ...
        <section className="mb-8">
          ...
          <p>
            We may modify or terminate the Service at any time without prior
            notice.
          </p>
        </section>
        ...
        <section className="mb-8">
          ...
          <p>
            ...
            Service is operated. Any disputes will be resolved in the
