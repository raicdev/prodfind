...
export default async function ProductDetailPage({ params }: ProductDetailPageProps) {
  ...
  try {
    [product, bookmarkStatus, recommendationStatus] = await Promise.all([
      trpc.getProduct({ productId }),
      trpc.getBookmarkStatus({ productId }).catch(() => null),
      trpc.getRecommendationStatus({ productId }).catch(() => null),
    ]);
  } catch (error) {
    notFound();
  }
          ...
          <div className="flex items-center gap-4 md:gap-6 mb-8">
            ...
            <div className="flex-1">
              ...
              <div className="flex flex-wrap gap-2 mt-2">
                {(product.category as string[])?.map((cat: string, index: number) => (
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            ...
            <div className="md:col-span-1 space-y-6">
              <ProductActions
                ...
                initialRecommendationStatus={recommendationStatus || { isRecommended: false }}
              />
